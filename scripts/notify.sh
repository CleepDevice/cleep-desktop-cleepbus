...
# workaround to send slack notifications from windows that is not supported
# code from https://discuss.circleci.com/t/slack-integration-doesnt-support-windows-platform/37524/4
